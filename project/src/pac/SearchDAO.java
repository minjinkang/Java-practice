...
public class SearchDAO {
    ...
    public ArrayList<SearchData> readDataBlous() {
       ...
       try {
          ...
          while(rsBlous.next()) {
        	  arrBlous.add(new SearchData(rsBlous.getString(1), rsBlous.getInt(2), rsBlous.getString(3), rsBlous.getString(4)));
          }
       }
       catch (SQLException e) {
              e.printStackTrace();
    ...
    public ArrayList<SearchData> readDataShortT() {
        ...
        try {
           ...
           while(rsShotT.next()) {
        	   arrShortT.add(new SearchData(rsShotT.getString(1), rsShotT.getInt(2), rsShotT.getString(3), rsShotT.getString(4)));
           }
        }
        catch (SQLException e) {
               e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataLongT() {
          ...
          try {
             ...
             while(rsLongT.next()) {
            	 arrLongT.add(new SearchData(rsLongT.getString(1), rsLongT.getInt(2), rsLongT.getString(3), rsLongT.getString(4)));
             }
          }
          catch (SQLException e) {
                 e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataShirts() {
    	   ...
    	   try {
    		   ...
    		   while(rsShirt.next()) {
    			   arrShirts.add(new SearchData(rsShirt.getString(1), rsShirt.getInt(2), rsShirt.getString(3), rsShirt.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataShotP() {
    	   ...
    	   try {
    		   ...
    		   while(rsShotP.next()) {
    			   arrShortP.add(new SearchData(rsShotP.getString(1), rsShotP.getInt(2), rsShotP.getString(3), rsShotP.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataLongP() {
    	   ...
    	   try {
    		   ...
    		   while(rsLongP.next()) {
    			   arrLongP.add(new SearchData(rsLongP.getString(1), rsLongP.getInt(2), rsLongP.getString(3), rsLongP.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataShotS() {
    	   ...
    	   try {
    		   ...
    		   while(rsShotS.next()) {
    			   arrShotS.add(new SearchData(rsShotS.getString(1), rsShotS.getInt(2), rsShotS.getString(3), rsShotS.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
       ...
       public ArrayList<SearchData> readDataLongS() {
    	   ...
    	   try {
    		   ...
    		   while(rsLongS.next()) {
    			   arrLongS.add(new SearchData(rsLongS.getString(1), rsLongS.getInt(2), rsLongS.getString(3), rsLongS.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataCadigan() {
    	   ...
    	   try {
    		   ...
    		   while(rsCadigan.next()) {
    			   arrCadigan.add(new SearchData(rsCadigan.getString(1), rsCadigan.getInt(2), rsCadigan.getString(3), rsCadigan.getString(4)));
    		   }
    	   }
    	   catch (SQLException e) {
    		   e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataTweed() {
   	   ...
   	   try {
   		   ...
   		   while(rsTweed.next()) {
   			arrTweed.add(new SearchData(rsTweed.getString(1), rsTweed.getInt(2), rsTweed.getString(3), rsTweed.getString(4)));
   		   }
   	   }
   	   catch (SQLException e) {
   		   e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataShotJ() {
   	   ...
   	   try {
   		   ...
   		   while(rsShotJ.next()) {
   			arrShotJ.add(new SearchData(rsShotJ.getString(1), rsShotJ.getInt(2), rsShotJ.getString(3), rsShotJ.getString(4)));
   		   }
   	   }
   	   catch (SQLException e) {
   		   e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataLongJ() {
   	   ...
   	   try {
   		   ...
   		   while(rsLongJ.next()) {
   			arrLongJ.add(new SearchData(rsLongJ.getString(1), rsLongJ.getInt(2), rsLongJ.getString(3), rsLongJ.getString(4)));
   		   }
   	   }
   	   catch (SQLException e) {
   		   e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataEar() {
    	  ...
    	  try {
    		  ...
    		  while(rsEar.next()) {
    			  arrEar.add(new SearchData(rsEar.getString(1), rsEar.getInt(2), rsEar.getString(3), rsEar.getString(4)));
    		  }
    	  }
    	  catch (SQLException e) {
    		  e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataNeck() {
    	  ...
    	  try {
    		  ...
    		  while(rsNeck.next()) {
    			  arrNeck.add(new SearchData(rsNeck.getString(1), rsNeck.getInt(2), rsNeck.getString(3), rsNeck.getString(4)));
    		  }
    	  }
    	  catch (SQLException e) {
    		  e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataRing() {
    	  ...
    	  try {
    		  ...
    		  while(rsRing.next()) {
    			  arrRing.add(new SearchData(rsRing.getString(1), rsRing.getInt(2), rsRing.getString(3), rsRing.getString(4)));
    		  }
    	  }
    	  catch (SQLException e) {
    		  e.printStackTrace();
      ...
      public ArrayList<SearchData> readDataHairBand() {
    	  ...
    	  try {
    		  ...
    		  while(rsHairBand.next()) {
    			  arrHairBand.add(new SearchData(rsHairBand.getString(1), rsHairBand.getInt(2), rsHairBand.getString(3), rsHairBand.getString(4)));
    		  }
    	  }
    	  catch (SQLException e) {
    		  e.printStackTrace();
